...
//                _stateMachine.AddStateToQueue(new GoblinState.Near(_stateMachine, _goblinMain));
...
//            {
//                _stateMachine.AddStateToQueue(this);
//                return StateType.Success;
//            }
...
//        {
//            _goblinMain.Animator.SetBool("IsAttack", false);
//            _stateMachine.AddStateToQueue(new Idle(_stateMachine, _goblinMain));
//        }
//    }
