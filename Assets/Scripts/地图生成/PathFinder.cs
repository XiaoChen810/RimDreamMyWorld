...
public class PathFinder : MonoBehaviour
{
    ...
    public Node[,] InitNodes(int width, int height,MapCreator.MapTileData[,] mapTileData)
    {
        ...
        for (int i = 0; i < width; i++)
        {
            ...
            {
                nodes[i, j] = new Node(i, j, !(mapTileData[i, j].type == MapCreator.MapTileData.Type.water));
            }
        }
